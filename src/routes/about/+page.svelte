...
<div class="flex flex-col p-8 items-center drop-shadow">
    <h3 class="text-narrow font-xl font-semibold text-gray-800 text-center">
    ...
    <p class="font-lg text-gray-800 text-center my-4 max-w-[650px]">
...
<div class="flex flex-col p-8 items-center drop-shadow">
    <p class="font-lg text-gray-800 text-center my-4 max-w-[720px]">
